...
var CardFront = React.createClass({
  ...
  render: function render() {
    ...
    return React.createElement(
      ...
      React.createElement(ColorBar, { color: '#0000FF', left: '0%', width: '20%', x: x * 5.2 }),
      React.createElement(ColorBar, { color: '#0000FF', left: '20%', width: '20%', x: x * 4.7 }),
      React.createElement(ColorBar, { color: '#0000FF', left: '40%', width: '20%', x: x * 4.4 }),
      React.createElement(ColorBar, { color: '#0000FF', left: '60%', width: '20%', x: x * 4 }),
      React.createElement(ColorBar, { color: '#0000FF', left: '80%', width: '20%', x: x * 3.5 })
    );
  }
});
...
var CardBack = React.createClass({
  ...
  render: function render() {
    ...
    return React.createElement(
      ...
      React.createElement(ColorBar, { color: '#F9F9F9', width: '10%', left: '0%', x: 2 * (1 - x) }),
      React.createElement(ColorBar, { color: '#F9F9F9', width: '10%', left: '10%', x: 2.1 * (1 - x) }),
      React.createElement(ColorBar, { color: '#F9F9F9', width: '10%', left: '20%', x: 2.2 * (1 - x) }),
      React.createElement(ColorBar, { color: '#F9F9F9', width: '10%', left: '30%', x: 2.3 * (1 - x) }),
      React.createElement(ColorBar, { color: '#F9F9F9', width: '10%', left: '40%', x: 2.4 * (1 - x) }),
      React.createElement(ColorBar, { color: '#F9F9F9', width: '10%', left: '50%', x: 2.5 * (1 - x) }),
      React.createElement(ColorBar, { color: '#F9F9F9', width: '10%', left: '60%', x: 2.6 * (1 - x) }),
      React.createElement(ColorBar, { color: '#F9F9F9', width: '10%', left: '70%', x: 2.7 * (1 - x) }),
      React.createElement(ColorBar, { color: '#F9F9F9', width: '10%', left: '80%', x: 2.8 * (1 - x) }),
      React.createElement(ColorBar, { color: '#F9F9F9', width: '10%', left: '90%', x: 2.9 * (1 - x) })
    );
  }
});
